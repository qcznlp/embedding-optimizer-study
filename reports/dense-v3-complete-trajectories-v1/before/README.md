...
are HF-verified. Full retrieval evaluation is running. The current results are under `verified-v3-*`,
...
H100 hardware. Current evaluation workers and their source-bound handoffs must not be restarted
...
Both complete primary weight-geometry branches and the update map have now been computed. Full
functional encoding, inference and retrieval comparison remain incomplete; see the dated
