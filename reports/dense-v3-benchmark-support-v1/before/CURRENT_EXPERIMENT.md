...
Last observed **2026-09-10 18:57 UTC** (observer-reported timestamp). This is a dated execution snapshot, not a
live heartbeat or a scientific conclusion. Exact separately timestamped process
observations are in the [latest snapshot](reports/engineering-archive/dense-v3-endpoint-statistics-backup-v1/observations.json);
...
| Primary BEIR | **172 / 840 task cells**, eight exact primary workers live in this snapshot | All 12 rates × five stages × 14 tasks; no partial-task mean |
