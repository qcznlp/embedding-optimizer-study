...
Last observed **2026-09-10 15:04 UTC**. This is a dated execution snapshot, not a
live heartbeat or a scientific conclusion. Exact separately timestamped process
observations are in the [latest snapshot](reports/engineering-archive/dense-v3-first-complete-evaluations-v1/observations.json);
the [earlier snapshot](reports/engineering-archive/dense-v3-training-artifact-backup-v1/observations.json) is unchanged.
...
| Primary BEIR | **101 / 840 task cells**, eight exact workers live | All 12 rates × five stages × 14 tasks; no partial-task mean |
| Complete primary checkpoint BEIR | **[6 / 60](reports/engineering-archive/dense-v3-first-complete-evaluations-v1/tables/summary.md)**, all six pool-B final checkpoints; native readback and all 84 raw task values verified | Other six finals and all 48 intermediate checkpoints remain required |
...
speed advantage. The original source/admission flags and manuscript are unchanged.
