...
Last observed **2026-09-10 15:46 UTC**. This is a dated execution snapshot, not a
live heartbeat or a scientific conclusion. Exact separately timestamped process
observations are in the [latest snapshot](reports/paper-review/dense-v3-retrieval-usefulness-v1/observations.json);
the [six-complete-checkpoint snapshot](reports/engineering-archive/dense-v3-first-complete-evaluations-v1/observations.json) is unchanged.
...
| Primary BEIR | **107 / 840 task cells**, eight exact workers live | All 12 rates × five stages × 14 tasks; no partial-task mean |
