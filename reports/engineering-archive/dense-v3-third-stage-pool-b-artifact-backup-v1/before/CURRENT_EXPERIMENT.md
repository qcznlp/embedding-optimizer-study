...
Last observed **2026-09-11 22:41 UTC** (observer-reported timestamp). This is a dated execution snapshot, not a
live heartbeat or a scientific conclusion. Exact separately timestamped process
observations are in the [latest snapshot](reports/engineering-archive/dense-v3-third-stage-pool-b-evaluations-v1/observations.json);
...
| Primary BEIR | **604 / 840 task cells**, eight exact primary workers live in this snapshot | 236 cells remain; all 12 rates × five stages × 14 tasks stay required |
| Complete primary checkpoint BEIR | **[42 / 60](reports/engineering-archive/dense-v3-third-stage-pool-b-evaluations-v1/README.md)**, all twelve configurations at steps 782, 1563 and 3907 plus six pool-B step-2345 states; native and independent readback verify all 588 raw task values | Six pool-A step-2345 and all twelve step-3126 states remain; no full-trajectory claim |
| Third-stage pool-B score table | **[6 / 6 original configurations](reports/engineering-archive/dense-v3-third-stage-pool-b-evaluations-v1/tables/third-stage-pool-b-checkpoint-scores.md)**, 84 new task values; previous 36 complete records unchanged | Local archive only, not yet in HF evaluation backups; this is not the full twelve-configuration third-stage comparison |
