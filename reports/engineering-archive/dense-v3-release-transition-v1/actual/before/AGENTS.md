...
1. The explicit versioned scientific/document composition now works. Read
   ...
   152-case source-bound evidence. Finish the remaining reviewed default-entry,
   runtime/release-parent transition and curated source publication; do not claim
