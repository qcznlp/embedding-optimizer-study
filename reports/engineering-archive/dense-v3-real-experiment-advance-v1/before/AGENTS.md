...
The direct owner response answers the pending new-directory functional recovery
question. Proceed through the tested source-bound new recovery entry at
`/root/embedding-optimizer-v3-experiment/launch/functional-dimensions-recovery-v1`;
do not keep treating recovery approval as unanswered. Its actual native admission,
launch and terminal evidence must be read from CURRENT_EXPERIMENT and that new
namespace. Existing original numerical functions, accepted outputs, failed attempt,
old stopped controllers, both GPU lease namespaces and the protected-helper
exclusion remain intact. This is not permission to bypass a tool safety denial or
claim publication. Finish real functional analysis and the separately scoped
crossed continuation, rather than repeating completed fixture/backup work.
