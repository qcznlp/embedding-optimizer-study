...
Last observed **2026-09-10 11:28 UTC**. This is a dated execution snapshot, not a
live heartbeat or a scientific conclusion. Exact separately timestamped process
observations are in the [original snapshot](reports/engineering-archive/dense-v3-recovery-entry-v1/observations.json).
...
| Primary BEIR | **16 / 840 task cells**, eight exact workers live/R | All 12 rates × five stages × 14 tasks; no partial-task mean |
