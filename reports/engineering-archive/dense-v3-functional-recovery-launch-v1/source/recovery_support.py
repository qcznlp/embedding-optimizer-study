...
PINS = {
    ...
    OLD_OUTPUT / 'vectors/states/pretrained/manifest.json': '90d9f044b53c05065b00d16a53a31a5c82a37d86e33552d797f6c38364e64fac',
    OLD_OUTPUT / 'vectors/states/pretrained/vectors.npz': 'e57057107312363619ebb1ba19b55892fe539568d9545726f3c9b9277325112f',
...
def authority(here, source_sha, authorization_sha, settings):
    ...
    need(value['recovery_scope'] == SCOPE and value['source_sha256'] == source_sha
         ...
         and value['native_guards_modified'] is False
         and value['committed_source_release'] is False
         and value['scientific_completion'] is False and value['settings'] == settings
         and value['functional_source_sha256'] == PINS[ORIGINAL / 'functional.py']
         and value['inputs_sha256'] == PINS[ORIGINAL / 'inputs.json'],
