...
| Full functional-flow preparation | **[18 new isolated integration tests passed](reports/engineering-archive/dense-v3-functional-flow-candidate-v1/README.md)**; whole coordinator, vector finalizer and feature-worker bodies exercised with explicit stubs; nested observation and origin-preserving reuse integrated | Do not repeat these completed fixture tests as missing work. Production recovery authentication/launcher, exact launched-handle/lease admission and execution approval remain required; genuine copied-pretrained compatibility is now separately verified below |
| Genuine pretrained-copy compatibility | **[Two successful native reads](reports/engineering-archive/dense-v3-pretrained-native-copy-v1/README.md)** of original/copied genuine vectors; 134 checkpoint-backed tensor fingerprints each, four bitwise-equal arrays and two refusal controls | The same already accepted state, not two new states. Copy reuse is not installed in production; no model encoding or feature computation |
