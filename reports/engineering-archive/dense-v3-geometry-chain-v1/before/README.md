...
paper/audit checkout passes **all 1,891 cases**, including 45 changed-entry measurement checks.
...
then integrate v3 weight-space/dimension/publication consumers, the separately routed
