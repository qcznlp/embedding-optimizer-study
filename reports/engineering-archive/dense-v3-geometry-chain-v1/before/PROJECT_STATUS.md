...
Last updated: **2026-09-06 18:54 UTC**; the machine-readable snapshot is refreshed at this handoff.

## Where the project stands

**The revised-data natural preflight and prepared v3 core, validation and outcome checks pass. A corrected individual-entry measurement now passes real-checkpoint independent replay. Full geometry/dimension/publication integration and formal deployment remain incomplete. The old matrix stays on scientific hold.**
...
| Isolated paper/audit suite | 1,891 cases, zero failures/errors/skips with absolute source paths; failed relative-path invocation preserved | Correctness of the different numerical candidate source tree or formal scientific acceptance |
...
1,891 cases / zero failures. The older candidate's 923-case receipt remains valid historical evidence.
...
2. The expanded six-training/52-validation-group revision is now materialized and independently
   ...
   The exact individual-entry census now passes real diagnostic and fresh CPU replay. Next
   integrate the full spectral/subspace geometry, dimension and publication consumers; do not
   reuse the old matrix-mass proxy as an entry fraction. Retain the distinct old
