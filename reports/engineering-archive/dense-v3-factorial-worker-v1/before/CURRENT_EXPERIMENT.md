...
Last observed **2026-09-10 12:22 UTC**. This is a dated execution snapshot, not a
live heartbeat or a scientific conclusion. Exact separately timestamped process
observations are in the [latest snapshot](reports/engineering-archive/dense-v3-weight-artifact-backup-v1/observations.json);
the [earlier snapshot](reports/engineering-archive/dense-v3-recovery-entry-v1/observations-later.json) is unchanged.
...
| Primary BEIR | **22 / 840 task cells**, eight exact workers live | All 12 rates × five stages × 14 tasks; no partial-task mean |
...
3. Complete the separately gated crossed continuation: two fixed source states
   ...
   [factory/component checks](reports/engineering-archive/dense-v3-factorial-factory-v1/README.md)
   are not GPU calibration, default-topology GPU admission or a formal run.
