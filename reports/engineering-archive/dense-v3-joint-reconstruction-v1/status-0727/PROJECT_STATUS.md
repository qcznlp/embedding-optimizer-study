...
Updated: **2026-09-07 07:10 UTC**. This is local preparation, not a released experiment.
...
refusals on both. Next are original/functional inference reconstruction and primary publication,
...
is implemented but not yet accepted. Its corrected 25 focused tests pass. The complete synthetic
fixture and independent joins, original 540 predictions, functional 240 predictions, task-family
intervals and figure-point checks have returned successfully. Cold audit 18914 and isolated full
regression 47895 are still live; follow [the exact call record](reports/engineering-archive/dense-v3-joint-reconstruction-v1/RUNNING.md).
An independent complete replay has not started. No new primary result or manuscript value exists.
...
three branches. The latest terminal full-suite result is still the 2,548-case geometry milestone.
...
original/functional bridge and inference reconstruction and primary publication remain pending.
...
1. Finish the running joint cold audit/full regression and independent complete replay; preserve
   the new integration failures and do not repeat terminal standalone work. The original and
   functional consumers now connect to the local-role raw reconstructions, with acceptance still
   pending. Geometry's 67 focused cases, full 2,548-case regression and both cold
