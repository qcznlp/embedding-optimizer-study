...
Updated: **2026-09-07 08:08 UTC**. This is local preparation, not a released experiment.
...
Independent complete replay **74613** is live at 07:45 UTC. Follow
[the exact call record](reports/engineering-archive/dense-v3-joint-reconstruction-v1/RUNNING.md).
The independent positive replay now matches all 477 outputs; its semantic controls remain
running and no terminal joint acceptance exists. No new primary result or manuscript value exists.
...
1. Finish the running independent complete joint replay and bounded acceptance; preserve
