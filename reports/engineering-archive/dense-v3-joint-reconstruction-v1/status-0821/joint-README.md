# Joint raw-to-inference reconstruction — verification in progress

Updated 2026-09-07 07:45 UTC. This is explicitly synthetic engineering work,
...
- The corrected complete fixture has now been assembled. Its independent joint
  ...
  imports. Independent complete replay **74613** is running. No terminal joint
  acceptance or successful independent complete replay is claimed yet.
...
Follow [RUNNING.md](RUNNING.md) for exact active handles. Do not modify the sources
bound by those calls, restart them after an observation timeout, or treat a passing
prefix as completion. Late-table negative controls explicitly reuse the same cold
