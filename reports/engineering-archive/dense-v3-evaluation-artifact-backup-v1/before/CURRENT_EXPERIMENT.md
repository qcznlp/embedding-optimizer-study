...
Last observed **2026-09-10 17:01 UTC** (observer-reported timestamp). This is a dated execution snapshot, not a
live heartbeat or a scientific conclusion. Exact separately timestamped process
observations are in the [latest snapshot](reports/engineering-archive/dense-v3-validation-selection-readback-v1/observations.json);
...
| Primary BEIR | **168 / 840 task cells**, eight exact primary workers live in this snapshot | All 12 rates × five stages × 14 tasks; no partial-task mean |
...
the small local readback archive is not their off-host backup.
