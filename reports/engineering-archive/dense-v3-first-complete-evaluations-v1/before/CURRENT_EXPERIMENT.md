...
Last observed **2026-09-10 14:15 UTC**. This is a dated execution snapshot, not a
live heartbeat or a scientific conclusion. Exact separately timestamped process
observations are in the [latest snapshot](reports/engineering-archive/dense-v3-training-artifact-backup-v1/observations.json);
the [earlier snapshot](reports/engineering-archive/dense-v3-training-observations-v1/observations.json) is unchanged.
...
| Primary BEIR | **43 / 840 task cells**, eight exact workers live | All 12 rates × five stages × 14 tasks; no partial-task mean |
