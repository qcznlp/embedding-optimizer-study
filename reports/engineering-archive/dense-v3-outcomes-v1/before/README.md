...
paper/audit checkout passes **all 1,777 cases**, including 67 v3 validation checks.
...
then integrate v3 outcome/dimension/publication consumers, the separately routed
