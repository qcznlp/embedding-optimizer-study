...
PROTOCOL_SHA = "914996b3423ba01329c03844419cca61e2a33452fe026665bb940d5b82e2cffe"
...
def load(root, training_root):
    ...
    path = root / "configs/dense_primary_v3_outcome_protocol.json"
    if file_identity(path)["sha256"] != PROTOCOL_SHA:
        raise ValueError("Wrong actual outcome protocol")
