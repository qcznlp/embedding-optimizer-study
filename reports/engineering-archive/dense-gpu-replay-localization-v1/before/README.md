...
entry state, row order and RNG restore exactly, but later numerical replay differs and remains
under investigation. Read the [GPU evidence and boundaries](reports/engineering-archive/dense-gpu-correctness-v1/README.md).
