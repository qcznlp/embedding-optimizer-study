# Completed primary-training continuation

Started 2026-09-08 13:14 UTC for the ten then-remaining fresh runs. All ten are
now complete; with the two initial runs, all twelve v3 training runs are accepted.
The vanished supervisors' final two workers have separate artifact/termination
proofs with unobserved OS exit codes; do not restart this completed queue.
...
Actual active-run identities from the frozen v3 input binding:

- Muon 1e-4: 224eae57f298f7b2e1fc09bddd1f5e4f8b254b7ed28f9f8b14692df877a02b23.
- Muon 3e-3: 67131fd12c57dd05c699ef23e454a556c02693738477a8bf470523cbdb868a01.

Actual config SHA-256 and source-derived W&B IDs:

- verified-v3-muon-1e-4: config `5108443beeda70e4a6f2a29ec5636b30dd94c37137dcad90d4ad89b0a99adcba`;
  W&B `study-v5-dense-verified-v3-muon-1e-4-seed42-unfused-bfloat16-v1`.
- verified-v3-muon-3e-3: config `46585f99dafe92e798bf6c468da1972bfa1c2b5902c3879522b47e8901280eb9`;
  W&B `study-v5-dense-verified-v3-muon-3e-3-seed42-unfused-bfloat16-v1`.

All acceptance sections below are historical; their former current-pair wording
does not authorize a dispatch, restart or change to the current queues.

## Completed third-pair final acceptance

| Run | Step | Immutable HF commit | Logical bytes |
| --- | --- | --- | --- |
| verified-v3-muon-1e-3 | 3907 | de69cb698cde961cf916e22df20589a1c3a82d62 | 1,350,928,730 |
| verified-v3-normuon-1e-3 | 3907 | 680b1a1bf5b639efdb74b5b42a7158de8fb15529 | 1,351,494,853 |

At that earlier transition the unchanged backup watcher **79029 / 1599515** had thirty immutable audits:
**600 files / 44,944,912,338 logical bytes, 30 / 60 checkpoints**. Integration
**11914** is terminal/pass at 04:56: all thirty exact receipts match and every
new final-stage local file was rehashed. This is not another network/deep-tensor
audit. The original automatic full reader already checked all five stages of
each completed run. Final metadata, timing and all six run acceptances are bound
by the transition observation and its earlier complete-pair anchor.

Third-pair `.view-verified.json` SHAs are
e45ec40da17dd471ffccad8e1da5898a2f9baeeff948caf12e6ae9a502026f78 (Muon) and
1ec11b0f47f919031a32ca731dd0bbac5dde9bdbb20e6bcf89ef4dbcd35507e3 (NorMuon).
The original single-selection guard remains false; no source release or
scientific result is claimed. The current AdamW pair's first-stage acceptance is recorded above.

## Earlier milestones — historical third-pair wording is not a current instruction

Initial read **19048** is terminal/pass at 21:12: 8 / 5 expected rows through
actual endpoints 70 / 40, no missing/duplicate rows, finite metrics and zero LR
error. Final second-pair read **65067** is terminal/pass at 21:07: both finished,
391 expected rows through 3900 each, finite metrics and zero LR error. Whole-run
records independently prove update 3907 and epoch 1.0. Ninety-percent read 65461
is terminal/pass and retained; all earlier reads remain historical evidence.

Post-warmup read **69593** is terminal/pass at 21:56: 44 / 41 expected rows through
actual endpoints 430 / 400, with no missing/duplicate rows, finite values and zero
LR error. The later local read observes 442 / 417. Observation **227** is terminal
with both workers actually past warmup; the three training/backup sessions remain
live. Evidence and exact commands:
[post-warmup observation](../observations/third-pair-post-warmup-20260908.json).
This adds no whole-run, checkpoint, payload-audit or scientific acceptance.

Rank-admission JSON records may share a physical line. Decode each complete flat
record and require exactly ranks 0/1/2/3 with the bound run identity, not one JSON
object per line. Both current workers satisfy this check. Full evidence and
read-only commands are in
[the transition observation](../observations/second-pair-complete-third-pair-running-20260908.json).

The CPU backup watcher remains **79029**, PID **1599515**, unchanged. All twenty
first/second-pair checkpoints plus eight current retained checkpoints passed
immutable remote audits: **560 files / 42,242,488,755 logical bytes, 28 / 60 stages**.
Only exact owned handles may be monitored; never inspect or touch the protected
helper. The old stopped dispatcher chain is untouched.

## Current pair: fourth checkpoint

| Run | Step | Immutable HF commit | Logical bytes |
| --- | --- | --- | --- |
| verified-v3-muon-1e-3 | 3126 | f4cd570f0f8af0e154756700a2813b07a0fbefcf | 1,350,912,414 |
| verified-v3-normuon-1e-3 | 3126 | aab2fac6abb3542e378601215bd86ceff59c6d3c | 1,351,478,522 |

Receipt integration **85587** is terminal/pass at 03:23: all twenty-eight exact
commits, identities, inventories and receipt hashes match, and every new local
file was rehashed. The unchanged watcher performed the immutable network audits;
this integration is not another network or deep-tensor audit. Post-save W&B read
**34479** is terminal/pass: all 314 / 317 expected records through actual endpoints
3130 / 3160, finite values and zero LR error. Both logs continue after saving.

Observer **273** is terminal with both fourth checkpoints remotely verified;
actual sessions 52244 / 97554 / 79029 remain live at the 03:23 handoff. Evidence:
[fourth-checkpoint observation](../observations/third-pair-fourth-checkpoints-20260909.json).
Both current full runs remain incomplete. Continue toward final step 3907; the
unchanged automatic reader must still deep-read all five stages and admit the
explicit exact view history. Existing coordinators then dispatch AdamW 1e-6 in
pool A and AdamW 3e-6 in pool B. Read actual exit/view-verified/next-started records
at that transition; do not manually launch workers or restart a live coordinator.

## Current pair: third checkpoint (earlier milestone)

| Run | Step | Immutable HF commit | Logical bytes |
| --- | --- | --- | --- |
| verified-v3-muon-1e-3 | 2345 | 245fd8fd2ad6d70d3e073ae80a7b7afd1e2cddb4 | 1,350,896,116 |
| verified-v3-normuon-1e-3 | 2345 | 606cf33223e0b98d2098dd1b5b2653339d362035 | 1,351,462,207 |

Receipt integration **64329** is terminal/pass at 01:49: all twenty-six exact
commits, identities, inventories and receipt hashes match, and every new local
file was rehashed. The unchanged watcher performed the immutable network audits;
this integration is not another network or deep-tensor audit. Post-save W&B read
**41976** is terminal/pass: all 236 / 238 expected records through actual endpoints
2350 / 2370, finite metrics and zero LR error. Both logs continue after saving.

Observer **265** is terminal with both third checkpoints remotely verified;
actual sessions 52244 / 97554 / 79029 remain live at the 01:50 handoff. Evidence:
[third-checkpoint observation](../observations/third-pair-third-checkpoints-20260909.json).
Both current runs are still incomplete. The unchanged automatic whole-run reader
will deep-read all five stages at actual completion; no new deep-tensor read is
claimed for this stage. The next save at that earlier observation was step 3126.

## Current pair: second checkpoint (earlier milestone)

| Run | Step | Immutable HF commit | Logical bytes |
| --- | --- | --- | --- |
| verified-v3-muon-1e-3 | 1563 | e41efce14ec736bb7061f9d68cee51a97c32a776 | 1,350,879,852 |
| verified-v3-normuon-1e-3 | 1563 | cadfa256088822cbf383bfc5b1847107a7533619 | 1,351,445,940 |

Receipt integration **33974** is terminal/pass at 00:16: all twenty-four exact
commits, identities, inventories and receipt hashes match, and every new local
file was rehashed. The unchanged watcher performed the immutable network audits;
this integration is not another network or deep-tensor audit. Post-save W&B read
**20932** is terminal/pass: all 159 / 158 expected records through actual endpoints
1580 / 1570, finite metrics and zero LR error. Both local logs continue after saving.

Observer **251** is terminal with both second checkpoints remotely verified;
actual sessions 52244 / 97554 / 79029 remain live at 00:17, not stopped. Evidence:
[second-checkpoint observation](../observations/third-pair-second-checkpoints-20260909.json).
No new deep-tensor read is claimed for this stage: the first-stage reads below
already passed, and the unchanged automatic whole-run reader will read all five
stages at actual completion. Both current full runs remained incomplete; the next
save at that earlier observation was step 2345. These completed checks are not missing work.

## Current pair: first checkpoint (earlier milestone)

| Run | Step | Immutable HF commit | Logical bytes |
| --- | --- | --- | --- |
| verified-v3-muon-1e-3 | 782 | 96c42189cee58a52615f1fd834a17d40d2f8cd4c | 1,350,863,552 |
| verified-v3-normuon-1e-3 | 782 | 916108e06bf2eef4c4aac301dec71c7673ebcc5d | 1,351,429,635 |

Actual original deep-state reads **64977 / 46665** are terminal/pass. Both have
134 parameter states, three groups [88,1,45] and scheduler step 782; the sealed
payload is unchanged before/after each CPU-only read. No CUDA context was created.
Deep receipt SHAs are 08c9cbcf2e1a586bc84984d03d4fe3367172b654c7aa5f5ab79d8fba17652959
and 6522351cfe845a23fb12b385bed0cab5769388ca75d11aa1f17e13aee587075f.

Receipt integration **36953** is terminal/pass at 22:44: all twenty-two exact
commits, identities, inventories and receipt hashes match, and every new local
file was rehashed. The original watcher performed the immutable network audits;
this integration is not another network/deep-tensor audit. Post-save W&B read
**32912** is terminal/pass: all 84 / 82 expected records through actual endpoints
830 / 810, finite metrics and zero LR error. Both actual logs continue after saving.

Observation **233** is terminal with both first checkpoints remotely verified and
training continuing. The three actual sessions remain live, not stopped. Exact
commands, full results and proof bindings:
[first-checkpoint observation](../observations/third-pair-first-checkpoints-20260908.json).
Do not rerun these completed checks as missing work. Neither current full run is
complete; no retrieval, mechanism or committed-source-release finding is claimed.

## Completed second-pair checkpoint acceptance

| Run | Step | Immutable HF commit | Logical bytes |
| --- | --- | --- | --- |
| verified-v3-normuon-3e-4 | 782 | 59efd55774a8ccc054802041844f2b309d8d7eda | 1,351,429,646 |
| verified-v3-adamw-1e-5 | 782 | 5ee3804cc2358b32f70531792adb10e678459399 | 1,792,100,124 |
| verified-v3-normuon-3e-4 | 1563 | 895318dd58f5efd51cdf4d3c4ac238d40e28aa73 | 1,351,445,994 |
| verified-v3-adamw-1e-5 | 1563 | 3b29a182baaf5f9acea3045d1d7dd7b2a3a0e6ab | 1,792,116,423 |
| verified-v3-normuon-3e-4 | 2345 | 85bb81ac24c935aa5880591135d82815f114b54e | 1,351,462,318 |
| verified-v3-adamw-1e-5 | 2345 | 0568fa4c506b03db9376a9487f7851c7990ef43b | 1,792,132,685 |
| verified-v3-normuon-3e-4 | 3126 | 7d3441e6360c02718b0f4a83fd8b91087a35de9a | 1,351,478,636 |
| verified-v3-adamw-1e-5 | 3126 | adcc06c044590db2f6daab8dda5a1e59ecb2df7e | 1,792,148,976 |
| verified-v3-normuon-3e-4 | 3907 | 61218ad3c3569eb5a169cb58be8df879c7a531c8 | 1,351,494,941 |
| verified-v3-adamw-1e-5 | 3907 | 0e7fbc537a8fd8e69b2cda07ab8dd8f254868836 | 1,792,165,282 |

Read-only integration **85915** is terminal/pass at 21:10: all twenty exact commit
receipts, identities, authority, inventories and recorded hashes match. Every
new step-3907 local file was rehashed and matches. The original watcher performed
the immutable network audits; this integration is not another network/deep-tensor
audit. Its exact command and result are in the transition observation above.

Complete second-pair `.view-verified.json` receipt SHAs:

- NorMuon 3e-4: ee4031e2a49b66e1fd5938acd2d3acc5df79eb7cc9573caed6fd19d737bc2535.
- AdamW 1e-5: ce708b79780804b074e0c0fceea853a7e5d02fb31160e671693e01bb26b377af.

These retain the explicit correction below; the original single-selection guard
has not passed. Later code consolidation must integrate this into downstream
consumers explicitly. No retrieval or scientific conclusion follows from training
or durability acceptance, and no committed-source release is claimed.

Earlier per-stage receipt integrations 34931 / 78085 / 28441 and step-782 actual
deep-state reads 26277 / 78930 are terminal/pass, not missing work. Their original
observations, full commands, exact hashes and any read failures remain preserved
in `../observations/second-pair-*-checkpoints-20260908.json`, the separate step-782
deep JSONs, and the earlier 20:10 late-health observation. Do not repeat those
completed bounded checks or represent them as independent scientific findings.

## Why a new coordinator exists

Both first training children completed all 3,907 updates and exited zero:
Muon at 13:03:58 and AdamW at 13:04:11. Original coordinators **55261 and 28273
are terminal/exit 1**, not live jobs. Both stopped in post-training verification:
`PrimaryV3Contract.complete_run` called the complete original payload/deep-state
reader successfully, then rejected an operation-history fingerprint mismatch.
Do not restart those queues or overwrite their records.

The unchanged `dense_run_contract.prepare` selects the ten required columns.
The unchanged `train.run_training` selects those same columns a second time.
The dataset library assigns different history fingerprints to these identical
views: raw `0c6bd82f699a563c`, once `5a2cdf9a1ae149bc`, twice
`0c29f5d460d1b4d7`. Both completions correctly recorded the latter; the additional
old v3 guard expected the former. This is not evidence of different training data.

The actual full input audit checks all eighteen immutable input-file identities
before and after reconstruction, all 500,000 rows, column order, Arrow table
content and metadata, features, formatting, and absence of row indices. All pass.
Eight bounded refusal cases also pass, including changed content with a forged
matching fingerprint. The actual full model/optimizer/state reader was rerun,
unchanged, for both first runs (14423 and 39675, terminal/exit 0).

The new coordinator uses that same full payload reader plus the explicit audited
two-selection history. It emits separately scoped `../logs/<run>.view-verified.json`
records; it does **not** fabricate an original `.verified.json` or rewrite
`completed.json`, fingerprints, checkpoints, source bindings or draft contracts.
Original failures remain in
`../observations/first-pair-view-guard-failure-20260908.json`.

Training workers are still the exact original `train_matrix.py --worker` entry,
with unchanged 56-file source, data, base, optimizer, random order and 3,907-step
recipes. The continuation skips only the two fully checked completed runs and
uses fresh-only outputs for all remaining ten. Both original lease namespaces,
descriptor inheritance, exact stopped-chain checks and fail-closed behavior are
reused. No lock or old controller was removed or modified.

## Frozen operational bindings

- continue_matrix.py: c1602e493b68fe52ce487389a5275452bd4c003706af3d66c61b7c6f0cd9d1cf
- authorization.json: 5c6cbd1ae85d6c8bae56bee2409eb59562b3ee603b57dfcfc6e84c97b1927cf7
- input-view-audit.json: 13cb27173e48b8262aae77cba6ed5ebb03d9839f10fec409af06beac570af473
- guard-refusals.json: fb2d978deaa3af36c2a0e5bc4deaeac5abab5cbc1e9ebd7e260e086c8848b15d
- original failure record: 408b3b8b3024002dcc0b6e922ab3cb7f726374e12e20e847fa96fca196bb7511
- AdamW first-run view-verified receipt: 4035f4c714a959a47d13ca5f027d39938e357606a983069023bf91cceae1885c
- Muon first-run view-verified receipt: 5845f0e3129de0cee0f0706d2f53ab18f7758f23cc2f2cd4e0bf03c673e4a57d

Do not edit the active continuation, manifest, original source, launcher, data or
watcher. All new authority is a documented implementation of the owner's existing
training-first instruction, not a Git/source release or old-controller transition.
The original v3 complete-run fingerprint guard remains unchanged and rejects these
history tags. Later code consolidation must integrate this exact content/history
correction into downstream consumers explicitly; do not claim they already pass.
No paper/retrieval/optimization-quality conclusion follows from these receipts.
This operational incident must not enter the manuscript, including its appendix.
