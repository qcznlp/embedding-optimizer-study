...
Updated: **2026-09-07 04:35 UTC**. This is local preparation, not a released experiment.
...
also passes both complete cold audits and 62 focused cases. All 2,481 isolated regression tests
pass; the first test/launcher failures are preserved, with production numerics unchanged.
Next are original geometry/inference reconstruction and primary publication,
...
numerical outputs, but original geometry/inference reconstruction and primary publication remain pending.
...
1. Complete the original geometry local-role reader, preserving the distinction between
   ...
   missing. Follow the [inspected next boundary](reports/engineering-archive/dense-v3-outcome-reconstruction-v1/next-geometry-boundary.md). Preserve all source
...
2. Complete numerical reconstruction on the externally anchored local roles: original geometry
   primitives, original and functional bridges, fixed inference families
