...
geometry/inference reconstruction and final publication remain pending. These are not optimizer findings. Choices are retained
...
The latest isolated full retry passes 2,481 cases. The [original-outcome reader](reports/engineering-archive/dense-v3-outcome-reconstruction-v1/README.md)
