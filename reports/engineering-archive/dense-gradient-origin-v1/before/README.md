...
fixture, a few BF16 rounding differences spread through Newton–Schulz. The first gradient-difference
source remains unisolated. This is not an optimizer-quality finding or acceptance of the still-failed
full replay. All 1,337 regression cases pass with absolute audited source paths. Read the
