...
Last observed **2026-09-12 04:01 UTC** (observer-reported timestamp). This is a dated execution snapshot, not a
live heartbeat or a scientific conclusion. Exact separately timestamped process
observations are in the [latest snapshot](reports/engineering-archive/dense-v3-campaign-evidence-candidate-v1/observations.json);
...
| Primary BEIR | **684 / 840 task cells**, eight exact primary workers live in this snapshot | 156 cells remain; all 12 rates × five stages × 14 tasks stay required |
...
1. Finish the remaining 164 cells of the existing full 840-cell evaluation matrix
   ...
   the original six-state pool-B backup and every earlier snapshot.
