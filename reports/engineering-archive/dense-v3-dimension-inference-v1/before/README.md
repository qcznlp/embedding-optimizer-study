...
The [latest engineering milestone](reports/engineering-archive/dense-v3-dimension-chain-v1/README.md)
connects complete v3 export/feature readers, verifies actual pretrained loading and probe identities,
and rehearses all 61 states synthetically with relocated fresh readback. No primary model was
encoded; task-family inference and publication remain pending. Scientific choices are retained
...
The final isolated suite passes 2,270 cases; the archive also retains 55 new focused checks and
four compatibility regressions. On this host the pinned interpreter is `/usr/bin/python`; the old live `.venv`
...
[reproduction record](reports/engineering-archive/dense-v3-dimension-chain-v1/commands.md).
