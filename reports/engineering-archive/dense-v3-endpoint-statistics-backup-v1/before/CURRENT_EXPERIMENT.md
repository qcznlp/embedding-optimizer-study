...
Last observed **2026-09-10 17:59 UTC** (observer-reported timestamp). This is a dated execution snapshot, not a
live heartbeat or a scientific conclusion. Exact separately timestamped process
observations are in the [latest snapshot](reports/dense-v3-final-inference-v1/observations.json);
