...
Last observed **2026-09-10 11:45–11:47 UTC**. This is a dated execution snapshot, not a
live heartbeat or a scientific conclusion. Exact separately timestamped process
observations are in the [latest snapshot](reports/engineering-archive/dense-v3-recovery-entry-v1/observations-later.json);
the [earlier snapshot](reports/engineering-archive/dense-v3-recovery-entry-v1/observations.json) is unchanged.
...
| Primary BEIR | **17 / 840 task cells**, eight exact workers live | All 12 rates × five stages × 14 tasks; no partial-task mean |
