...
Last observed **2026-09-10 16:15 UTC** (observer-reported timestamp). This is a dated execution snapshot, not a
live heartbeat or a scientific conclusion. Exact separately timestamped process
observations are in the [latest snapshot](reports/paper-review/coordinate-utility-interpretation-v1/observations.json);
...
| Primary BEIR | **121 / 840 task cells**, eight exact workers live | All 12 rates × five stages × 14 tasks; no partial-task mean |
