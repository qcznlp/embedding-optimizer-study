...
2. Resolve the scoped functional receipt-path recovery authority, preserving the
   ...
   The separate full-flow fixture integration is now complete. It does not create
   production authority or verify native model/vector kernels; real origin-bound
   copied-pretrained readback and reviewed recovery authentication still remain.
