...
paper/audit checkout passes **all 2,006 cases**, including 44 exact-geometry and seven probe-coupling checks.
...
claim follows. Next prepare an explicit exact/error-controlled primary geometry consumer, retaining
the original approximate features and all failed-attempt provenance.
...
then integrate exact/error-controlled primary geometry and v3 retrieval-bridge/dimension/publication consumers, the separately routed
