...
Last updated: **2026-09-06 20:34 UTC**; the artifact-only snapshot was refreshed at 20:31:40 UTC.

## Where the project stands

**Prepared data/core/validation/outcome/geometry consumers pass their bounded checks. Exact-projector and crossed-seed diagnostics now confirm that low-rank sketch accuracy and shared-probe coupling obstruct unqualified mechanism interpretation. An exact/error-controlled primary geometry consumer, bridge/dimension/publication integration and formal deployment remain incomplete. The old matrix stays on scientific hold.**
...
not a repair. These are not primary optimizer or useful-dimension findings. Prepare an explicit
prospective exact/error-controlled primary geometry consumer and retain the original approximate
features under correct names, then integrate retrieval/functional-dimension consumers. Do not repeat
...
| Isolated paper/audit suite | 2,006 cases, zero failures/errors/skips with absolute source paths; old failed attempts preserved | Correctness of the different numerical candidate source tree or formal scientific acceptance |
...
2,006 cases / zero failures. The older candidate's 923-case receipt remains valid historical evidence.
...
2. The expanded six-training/52-validation-group revision is now materialized and independently
   ...
   on the inherited diagnostic controls. Prepare an explicit exact/error-controlled primary geometry
   consumer, then integrate the v3 retrieval bridge, dimension and publication consumers. Neither
