...
At **2026-09-12 15:18 UTC**, two four-GPU crossed continuations are genuinely
training (**181/391 and 178/391**); both first step-79 checkpoints pass independent
native model/optimizer/scheduler/RNG readback. The separate CPU functional worker
has **25/61 native-verified feature states**. These are dated observations, not a
perpetual heartbeat; no complete crossed branch or functional inference is claimed
yet. Original vectors and all failed attempts remain preserved. See the current
handoff for the exact active entries; do not restart completed primary work.
...
Full functional inference and a supported mechanistic explanation remain
