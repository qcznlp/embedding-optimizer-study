...
paper/audit checkout passes **all 1,662 cases**, including 30 new amendment/coverage/owned-launch checks.
...
then integrate complete v3 primary/validation, downstream scientific consumers, the separately routed
