...
SCOPE = 'dense-v3-four-rank-paired-backward-boundary-v2'
...
def prepare(args):
    ...
    if unit['tests'] != '17' or any(unit[k] != '0' for k in ('errors', 'failures', 'skipped')):
    ...
    r.write(HERE / 'authorization.json', dict(scope=SCOPE, owner_message=r.OWNER,
        ...
        diagnostic_guard_correction='Observe native None item count; do not assume model_accepts_loss_kwargs is false',
