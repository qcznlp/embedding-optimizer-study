...
Both complete primary weight-geometry branches, the update map and all retained retrieval
outcomes have now been computed. Full functional encoding, functional inference and the
geometry-to-retrieval explanatory analysis remain incomplete; see the dated
