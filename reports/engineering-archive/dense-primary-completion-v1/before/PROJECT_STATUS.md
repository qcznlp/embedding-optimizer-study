...
Last updated: **2026-09-06 11:48 UTC**; the machine-readable snapshot is refreshed at this handoff.

## Where the project stands

**The revised primary input and consumer contract is prepared and tested; the formal matrix is still on scientific hold.**
...
| Isolated paper/audit suite | 1,475 cases, zero failures/errors/skips | Correctness of the different candidate source tree |
...
of these two source trees is rejected. Whole-run/task completion and downstream integration are
still pending. The original scientific recipes, selection rules and failed gates remain intact.
...
1,475 cases / zero failures. The older candidate's 923-case receipt remains valid historical evidence.
...
1. Review the [prepared primary input/consumer contract](reports/engineering-archive/dense-primary-contract-v1/README.md)
   and preceding [full-identity persistence evidence](reports/engineering-archive/dense-full-identity-v1/README.md).
   These bounded tasks are complete in preparation, not deployment. Do not redo the missing-gate
   diagnosis or infer real primary execution/upload/evaluation from the read-only rehearsal.
2. Complete/review whole-run terminal and complete-task gates and the downstream outcome,
   dimension/factorial/publication consumers. Prepare natural-data execution readiness and an
