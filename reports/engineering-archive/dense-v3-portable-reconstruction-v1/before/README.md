...
The [latest engineering milestone](reports/engineering-archive/dense-v3-dimension-inference-v1/README.md)
connects the task-family inference and four genuinely named functional predictors to the prepared
v3 interfaces. Independent statistical/exact-regression checks and relocated synthetic replay pass.
No primary model was encoded; final source-authenticated publication and portable reconstruction
remain pending. Synthetic tests are not optimizer findings. Scientific choices are retained
...
The final isolated suite passes 2,334 cases; the new milestone adds 64 focused checks and retains
the first failed independent-oracle attempt. On this host the
...
[reproduction record](reports/engineering-archive/dense-v3-dimension-inference-v1/commands.md).
