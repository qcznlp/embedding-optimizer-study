...
from scripts.pause_dense_evaluation_for_audit import SCRIPT, parse_stat, validate_worker_argv
...
class DensePauseGuards(unittest.TestCase):
    def argv(self):
        return [
            ...
            "FEVER",
            "--models",
            "/root/embedding-optimizer-study/outputs/dense-no-packing-v1/dense/padded-adamw-1e-6/checkpoint-782",
            "--results_folder",
            "/root/embedding-optimizer-study/results/dense-no-packing-beir/dense/a",
            "--bf16",
            "--fa2",
            "--local",
            "--decontaminated",
