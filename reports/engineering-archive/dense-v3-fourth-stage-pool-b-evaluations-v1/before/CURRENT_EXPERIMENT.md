...
Last observed **2026-09-12 04:11 UTC** (observer-reported timestamp). This is a dated execution snapshot, not a
live heartbeat or a scientific conclusion. Exact separately timestamped process
observations are in the [latest snapshot](reports/engineering-archive/dense-v3-campaign-evidence-backup-v1/observations.json);
