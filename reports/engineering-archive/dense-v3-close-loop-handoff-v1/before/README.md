...
At **2026-09-12 16:16 UTC**, the first **2/12 crossed continuations are complete**,
all ten new checkpoints are HF-verified, and the second pair is training at
**245/391 each**. The [functional inference](reports/dense-v3-functional-inference-v1/README.md)
