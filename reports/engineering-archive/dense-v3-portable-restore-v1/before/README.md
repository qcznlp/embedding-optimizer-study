...
| Recovery and remaining delivery | Both warm-reducer restores pass exact endpoint equality; portable recovery entry, versioned scientific-consumer integration and reviewed source publication remain |
