...
| Recovery and remaining delivery | Both genuine GPU restores pass exact endpoints; scoped recovery add-on is packaged and tested; versioned scientific-consumer integration and reviewed source publication remain |
