...
Dated snapshot: **2026-09-12 18:47 UTC**. This is not a perpetual heartbeat.
...
| Crossed continuations | **8/12 complete**; fifth pair at **245/391 and 239/391**, eight exact registered ranks live |
| New checkpoint verification/backup | **40** native checkpoint reads and **40** immutable HF metadata/hash checks complete; backup watcher remains active |
...
The [latest training observation](reports/engineering-archive/dense-v3-gpu-resume-v1/final-observations/training-final.json)
...
The first eight full branches provide actual production-topology/save/readback
...
Both training pools run disjoint balanced six-cell queues. Current fifth pair:
`factorial-v3-adamw_state-adamw-seed161803` (pool a) and
`factorial-v3-adamw_state-muon-seed161803` (pool b).
All four cells for both seeds 314159 and 271828 are complete.
...
The first six new runs (thirty checkpoints) are remotely verified in
...
`aea927abbe32dd56c2aeddf64b1f8ed0794d99e1`. The watcher backs up each of
...
4. Complete source-bound scientific consumption, portable reconstruction,
   ...
   manuscript, preserve all primary and exploratory results, and do not substitute
   for the still-required complete scientific/publication consumer or GPU resume.
