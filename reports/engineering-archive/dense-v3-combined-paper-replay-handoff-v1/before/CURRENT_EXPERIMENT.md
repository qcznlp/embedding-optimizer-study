...
Dated snapshot: **2026-09-12 21:53 UTC**. This is not a perpetual heartbeat.
...
At 21:52:52–53 UTC both BEIR coordinators and all four downstream CPU waiters are
...
[actual observation evidence](reports/engineering-archive/dense-v3-closed-primary-paper-replay-v1/README.md).
...
4. The complete current primary scientific-result consumer and the entire
   ...
   Complete the actual factorial scientific consumer, integrate both into a
   source-bound complete-document consumer, then finish portable reconstruction
   and final paper/reproducible-source release.
