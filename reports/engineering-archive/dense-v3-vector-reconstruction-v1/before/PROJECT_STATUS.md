...
Updated: **2026-09-07 02:00 UTC**. This is local preparation, not a released experiment.
...
bridges pass their bounded checks. This turn closes actual portable source dependencies and adds
checkpoint-backed authoring/file transport, tested with explicit synthetic upstream admission.
Next is primary publication and portable raw-vector numerical reconstruction,
...
[Portable source and transport preparation](reports/engineering-archive/dense-v3-portable-reconstruction-v1/README.md):
...
- **47 focused tests** and **2,381 full isolated tests** pass without failures, errors or skips.
...
Current full gather still records host-bound source paths. New transport preserves those bytes
and authenticates local files without reading the old paths; it does not yet recompute their content.
...
1. Preserve the completed inference/bridge checks, first failed oracle attempt and new source/
   transport acceptance. The
...
2. Build numerical reconstruction on the externally anchored local roles: all 61 raw-vector states,
   original outcome/geometry primitives, original and functional bridges, fixed inference families
