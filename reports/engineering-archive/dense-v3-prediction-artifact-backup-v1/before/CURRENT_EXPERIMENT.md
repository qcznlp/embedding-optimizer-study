...
1. Complete primary retrieval, its eight-table replay, all raw-score backups and
   ...
   Both new numerical reports/source are local, not yet remotely backed up or
   published. Their numerical outputs should receive immutable data-only backup
   and independent recovery; do not upload aggregate bundles containing Python.
