...
Next use a paired same-weight/input/RNG cold-versus-reused-reducer backward check,
separating local leaf contributions from actual post-DDP gradients, before any
new long endpoint attempt. Bucket logging alone does not establish a cause.
