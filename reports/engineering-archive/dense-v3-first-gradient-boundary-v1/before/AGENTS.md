...
Do not repeat those checks as missing. Actual device-loaded tensors, first collated
tokens and pre/post-reduction gradients remain unobserved; no backend cause is proven.
