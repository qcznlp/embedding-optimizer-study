...
Last observed **2026-09-11 06:32 UTC** (observer-reported timestamp). This is a dated execution snapshot, not a
live heartbeat or a scientific conclusion. Exact separately timestamped process
observations are in the [latest snapshot](reports/engineering-archive/dense-v3-functional-record-layout-candidate-v1/actual/observations.json);
...
| Primary BEIR | **348 / 840 task cells**, eight exact primary workers live in this snapshot | 492 cells remain; all 12 rates × five stages × 14 tasks stay required |
| Complete primary checkpoint BEIR | **[24 / 60](reports/engineering-archive/dense-v3-first-stage-evaluations-v1/README.md)**, all twelve first-stage and twelve final states; native readback and all 336 raw task values verified | All 36 checkpoints at steps 1563, 2345 and 3126 remain; no full-trajectory claim |
...
remain. Both original pools have naturally entered step 1563. No new statistical
test, rate selection, trajectory interpolation or manuscript finding was installed.

The same handoff records a [terminal functional-coordinator failure](reports/engineering-archive/dense-v3-first-stage-evaluations-v1/functional-first-state/README.md).
