...
Last observed **2026-09-11 13:55 UTC** (observer-reported timestamp). This is a dated execution snapshot, not a
live heartbeat or a scientific conclusion. Exact separately timestamped process
observations are in the [latest snapshot](reports/engineering-archive/dense-v3-complete-second-stage-evaluations-v1/observations.json);
...
| Primary BEIR | **504 / 840 task cells**, eight exact primary workers live in this snapshot | 336 cells remain; all 12 rates × five stages × 14 tasks stay required |
| Complete primary checkpoint BEIR | **[36 / 60](reports/engineering-archive/dense-v3-complete-second-stage-evaluations-v1/README.md)**, all twelve configurations at steps 782, 1563 and 3907; native readback and all 504 raw task values verified | All 24 states at steps 2345 / 3126 remain; no full-trajectory claim |
| Complete second-stage score table | **[12 / 12 configurations](reports/engineering-archive/dense-v3-complete-second-stage-evaluations-v1/tables/second-stage-checkpoint-scores.md)**, all 168 task scores; only six pool-A checkpoints / 84 values are new, and the previous 30 records are unchanged | New pool-A outcomes are local only; the existing six-state pool-B HF snapshot below remains unchanged |
