...
def run(args):
    ...
    assert contents["dimension-utilization.tex"].decode() == functional["rendered_latex"]
    plan = {
    ...
    if args.previous:
        ...
        for name, content in contents.items():
            path = args.previous.parent / "synthetic-evidence" / name
    ...
    result = {
        ...
        "previous_complete_result_match_verified": previous_match,
