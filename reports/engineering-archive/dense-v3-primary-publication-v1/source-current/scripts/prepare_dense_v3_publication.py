"""Prepare a new source-bound v3 evidence draft without reading experimental outcomes."""
...
from embed_optim.primary_v3_publication_contract import (
    OUTPUTS,
    PARENTS,
    RULES,
    SCOPE,
