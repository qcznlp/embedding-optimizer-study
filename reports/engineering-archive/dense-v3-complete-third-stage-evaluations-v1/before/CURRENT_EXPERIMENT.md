...
Last observed **2026-09-11 22:55 UTC** (observer-reported timestamp). This is a dated execution snapshot, not a
live heartbeat or a scientific conclusion. Exact separately timestamped process
observations are in the [latest snapshot](reports/engineering-archive/dense-v3-third-stage-pool-b-artifact-backup-v1/observations.json);
...
| Primary BEIR | **608 / 840 task cells**, eight exact primary workers live in this snapshot | 232 cells remain; all 12 rates × five stages × 14 tasks stay required |
