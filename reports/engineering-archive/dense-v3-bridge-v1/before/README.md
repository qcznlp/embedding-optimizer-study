...
paper/audit checkout passes **all 2,051 cases**, including 45 complete exact-geometry checks.
...
A separate fixed synthetic check exposes an **unrepaired bridge boundary**: a feature exactly
...
bridge is unchanged and the full counterexample is retained. Before integrating real outcomes,
explicitly correct and test numerical identifiability/zero-residual handling. A green existing
test suite does not negate this newly discovered case.
...
then repair the bridge boundary and integrate v3 retrieval-bridge/exact-sensitivity/dimension/publication consumers, the separately routed
