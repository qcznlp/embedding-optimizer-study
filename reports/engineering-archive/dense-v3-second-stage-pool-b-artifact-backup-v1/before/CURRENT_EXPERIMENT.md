...
Last observed **2026-09-11 12:06 UTC** (observer-reported timestamp). This is a dated execution snapshot, not a
live heartbeat or a scientific conclusion. Exact separately timestamped process
observations are in the [latest snapshot](reports/engineering-archive/dense-v3-second-stage-pool-b-evaluations-v1/observations.json);
...
| Primary BEIR | **436 / 840 task cells**, eight exact primary workers live in this snapshot | 404 cells remain; all 12 rates × five stages × 14 tasks stay required |
| Complete primary checkpoint BEIR | **[30 / 60](reports/engineering-archive/dense-v3-second-stage-pool-b-evaluations-v1/README.md)**, all twelve first-stage and twelve final states plus six step-1563 states; native readback and all 420 raw task values verified | Six step-1563 states and all 24 states at steps 2345 / 3126 remain; no full-trajectory claim |
| Step-1563 pool-B evaluation preservation | **[6 / 6 complete checkpoints](reports/engineering-archive/dense-v3-second-stage-pool-b-evaluations-v1/tables/new-checkpoint-scores.md)**, 84 new task values, with the previous 24 records exactly unchanged | Local archive only; not the complete twelve-configuration stage and not yet included in the earlier HF evaluation backups |
