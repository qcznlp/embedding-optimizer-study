...
| Source/distribution | Primary numerical sources integrated; original distribution audit passes; portable checkpoint inspection verified; [source guide](current-training-source.md) | Complete scientific-consumer/factorial compatibility and the reviewed release-parent transition remain required |
