...
preflight=json.loads(Path('/root/embedding-optimizer-story-refactor/reports/experiment-integrity/primary-geometry-ten-run-preflight.json').read_bytes())
api=HfApi(token=False)
rows=[]
for run in ['padded-normuon-1e-4','padded-normuon-3e-4']:
