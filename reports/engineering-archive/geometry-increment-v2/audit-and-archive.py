"""Audit ten completed primary geometry runs; add only missing HF files."""
...
def main():
    ...
    if args.upload and payloads:
        commit = api.create_commit(
            ...
            commit_message="Add audited completed NorMuon primary weight-space stages",
            operations=[
    ...
    output = {
        ...
        "repository": str(root),
        "runs": RUNS,
        "checkpoint_stages": len(RUNS) * len(STAGES),
