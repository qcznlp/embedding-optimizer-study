...
def main():
    ...
    for mode, filename in [('weight', 'weight-to-retrieval-map.pdf'), ('progress', 'full-rate-retrieval-trajectories.pdf')]:
        fig, axes = plt.subplots(1, 3, figsize=(7.0, 3.0), sharey=True, layout='constrained')
        for ax, optimizer in zip(axes, families, strict=True):
            ...
            ax.legend(title='Learning rate', title_fontsize=7, loc='upper center',
                      bbox_to_anchor=(.5, -.28), ncol=2, frameon=False,
