...
Last observed **2026-09-12 09:11 UTC** (observer-reported timestamp). This is a dated execution snapshot, not a
live heartbeat or a scientific conclusion. Exact separately timestamped process
observations are in the [latest snapshot](reports/engineering-archive/dense-v3-fourth-stage-pool-b-evaluations-v1/observations.json);
...
| Primary BEIR | **772 / 840 task cells**, four exact pool-A workers live; original pool B completed all 420 cells at 08:59 UTC | 68 cells remain; all 12 rates × five stages × 14 tasks stay required |
| Complete primary checkpoint BEIR | **[54 / 60](reports/engineering-archive/dense-v3-fourth-stage-pool-b-evaluations-v1/README.md)**, all twelve configurations at steps 782, 1563, 2345 and 3907 plus six original pool-B step-3126 states; native and independent readback verify all 756 raw task values | Six pool-A step-3126 states remain; the six new outcomes are locally archived only, not yet added to the earlier HF backups |
| Fourth-stage pool-B score table | **[6 / 6 original configurations](reports/engineering-archive/dense-v3-fourth-stage-pool-b-evaluations-v1/tables/fourth-stage-pool-b-checkpoint-scores.md)**, 84 new task values; all previous 48 complete records exactly unchanged | New immutable data-only backup and anonymous reconstruction remain; no partial-cohort optimizer-wide or mechanism verdict |
...
1. Finish the remaining 68 cells of the existing full 840-cell evaluation matrix
   ...
   the original six-state pool-B backup and every earlier snapshot. The newly
   verified six pool-B step-3126 outcomes still need an immutable data-only backup
   and anonymous reconstruction; do not repeat the completed prior backups.
