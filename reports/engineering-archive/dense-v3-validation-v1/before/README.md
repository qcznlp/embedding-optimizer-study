...
paper/audit checkout passes **all 1,710 cases**, including 48 v3 core-chain checks.
...
then integrate v3 validation scoring/selection, downstream scientific consumers, the separately routed
