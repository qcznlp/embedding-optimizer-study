...
Last updated: **2026-09-06 16:49 UTC**; the machine-readable snapshot is refreshed at this handoff.

## Where the project stands

**The revised-data natural preflight passes, and v3 core train/backup/BEIR/whole-grid consumers now pass an actual CPU rehearsal. Validation/outcome/mechanism/publication integration and formal deployment remain incomplete. The old matrix stays on scientific hold.**
...
All 48 focused and 1,710 isolated regression cases pass. The new I/O function bodies preserve the
...
BEIR. The validation scorer/selector, outcome/dimension/publication and routed-factorial integration
remain next work. Do not keep treating the prepared v3 core consumers as missing implementation.
...
| Isolated paper/audit suite | 1,710 cases, zero failures/errors/skips | Correctness of the different numerical candidate source tree or formal scientific acceptance |
...
1,710 cases / zero failures. The older candidate's 923-case receipt remains valid historical evidence.
...
2. The expanded six-training/52-validation-group revision is now materialized and independently
   ...
   are also prepared. Do not repeat these as missing work. Next integrate v3 validation scoring/
   selection, outcome, weight-space/dimension and publication consumers; retain the distinct old
