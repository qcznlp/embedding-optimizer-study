...
paper/audit checkout passes **all 1,538 cases**.
...
prepare natural-data execution readiness and integrate validation selection and downstream scientific consumers,
