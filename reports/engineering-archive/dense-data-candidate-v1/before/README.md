...
No replacement query or revised dataset exists yet. Original data and earlier evidence remain
unchanged. This is data hygiene, not an optimizer finding or a replacement for the numerical hold.
...
paper/audit checkout passes **all 1,606 cases**, including nine new query-protection checks. Passing
...
implement/review the [expanded 6/52-group data proposal](reports/engineering-archive/dense-data-partition-v1/revision-proposal.json),
