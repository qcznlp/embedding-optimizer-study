...
paper/audit checkout passes **all 1,955 cases**, including 64 complete-geometry/reduction checks.
...
then address geometry approximation robustness and integrate v3 retrieval-bridge/dimension/publication consumers, the separately routed
