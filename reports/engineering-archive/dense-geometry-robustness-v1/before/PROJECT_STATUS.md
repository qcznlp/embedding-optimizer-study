...
Last updated: **2026-09-06 19:55 UTC**; the machine-readable snapshot is refreshed at this handoff.

## Where the project stands

**Revised-data preflight and prepared v3 core, validation, outcome and complete geometry consumers pass their bounded checks. Real geometry replay passes after an explicit global-reduction precision correction. Exact-spectrum/projector robustness, bridge/dimension/publication integration and formal deployment remain incomplete. The old matrix stays on scientific hold.**
...
| Isolated paper/audit suite | 1,955 cases, zero failures/errors/skips with absolute source paths; old failed attempts preserved | Correctness of the different numerical candidate source tree or formal scientific acceptance |
...
1,955 cases / zero failures. The older candidate's 923-case receipt remains valid historical evidence.
...
2. The expanded six-training/52-validation-group revision is now materialized and independently
   ...
   fresh CPU replay. Add exact-spectrum/projector robustness to address the observed optimizer-
   dependent sketch errors, then integrate the v3 retrieval bridge, dimension and publication
   consumers. Preserve the frozen approximate features; do not reinterpret them as exact/useful
