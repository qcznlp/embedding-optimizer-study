...
Snapshot: **2026-09-13 06:34 UTC**, not a perpetual heartbeat.
...
| Continuation full-corpus retrieval | **108/168 complete**: 12 each ClimateFEVER/FEVER/MSMARCO/HotpotQA/DBPedia/QuoraRetrieval/Touche2020/NQ, 9 TRECCOVID, 1 FiQA2018 and 2 SciFact; eight workers running without failed task receipts |
| Complete continuation inference and paper | Queued behind full evaluation; final paper, combined replay and review remain incomplete |
| Remaining delivery checks | Full continuation-outcome backup, two GPU-resume checks and reviewed source release remain pending |

The existing queues automatically feed complete results into statistical
aggregation, document generation, numerical/PDF reconstruction and result
backup. Do not restart completed work or infer progress from an old snapshot.
...
The separate continuation contrasts remain pending.
...
| Actual training hardware | Eight NVIDIA L20Z GPUs, split into two four-GPU pools; not literal H100 hardware |
...
| Complete primary numerical result graph | [Paper-results reproduction](docs/paper-results-reproduction.md) |
...
The [development paper preview](reports/engineering-archive/dense-v3-current-publication-consumer-v1/actual/paper-preview-v2/build/main.pdf)
contains the completed primary findings but still has pending continuation
results. Final release requires complete actual results, reviewed prose,
strict document/distribution checks and complete reconstruction. Do not remove
