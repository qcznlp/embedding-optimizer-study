"""Exact original-bridge rendering, never checkpoint admission or paper installation."""

from collections import Counter
from fractions import Fraction

from .bridge_numerics import evaluate
from .corrected_publication import FEATURE_LABELS, _tex_escape
from .primary_contract import require_same


def checked_bridge(tables):
    """Retain the verified candidate behavior; recompute all five complete tables."""
...
def delta_text(row):
    """Display precision cannot override an exact sign or an undefined comparison."""
