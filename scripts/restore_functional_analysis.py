...
def files(root):
    ...
    need(
        value["scope"] == "actual-dense-v3-functional-and-calibration-durability-v1"
        and value["source_code_included"] is False
        and value["scientific_completion"] is False,
...
def verify(root):
    ...
    return dict(
        scope="actual-functional-calibration-artifact-integrity-verification",
