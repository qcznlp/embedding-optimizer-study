...
| Training-only paper tables | `reports/training-dynamics/summary_manifest.json` | Exactly 24 run rows, 120 five-stage trailing-window rows, six family/optimizer system summaries, and content hashes for every completion/schedule/history source pass audit. |
