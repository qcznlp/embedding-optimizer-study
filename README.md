...
This writes long-form task results, checkpoint means, training history, coverage checks, and training
dynamics plots under `reports/`. `--strict` fails unless all `24 × 5 × 14 = 1,680` evaluations are
present.
