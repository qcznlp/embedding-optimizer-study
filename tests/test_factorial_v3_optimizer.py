...
@pytest.mark.parametrize(
    ...
    [
        ...
        "scheduler_lr",
        "scheduler_horizon",
        "scheduler_extra_optimizer",
        "scheduler_extra_method",
        "untrusted_step",
    ],
)
def test_invalid_restore_refuses_before_mutating_either_fresh_object(name, change):
    ...
    if change == "names":
        ...
        horizon = 20
    elif change == "scheduler_extra_optimizer":
        saved_sched["optimizer"] = None
    elif change == "scheduler_extra_method":
        saved_sched["step"] = None
    else:
        expected_step = 5
