...
OUTPUTS = (
    ...
    "functional-inference.tex",
)
RULES = {
    "functional_table_binding": "Keep original functional-inference.tex exact; add only the required dimension-utilization label to the actual co-primary table in the manuscript-specific include",
    "csv_types": "Preserve declared exact rational fields as canonical strings, including integer-valued rationals and exact zero; undefined remains null",
